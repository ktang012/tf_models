...
layer_shape = np.array([[5, 784], [7, 5], [9, 7], [5, 9], [10, 5]])
num_features = 784
num_labels = 10

nn1 = MLP(num_features, num_labels, layer_shape,
          hidden_activation={2: 'sigmoid',
                             3: 'sigmoid',
                             4: 'sigmoid'}) # 4 should not be overwritten
nn1.print_fields() # layer 4 should still be softmax
